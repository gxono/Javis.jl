...
"""
    getjpaths!(video::Video,obj::Object,frame::Int, func::Function , args=[])

This is called at rendertime . `getjpaths!` updates `obj.jpaths` with jpaths that
are generated by drawing `func` . Typically `func` is `obj.opts[:original_func]`
"""
function getjpaths!(v::Video, obj::Object, f::Int, func::Function, args = [])
    m = getmatrix()
