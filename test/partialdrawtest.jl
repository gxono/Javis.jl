...
@testset "Testing Partial drawing of Object" begin
    ...
    @test_reference "refs/partialdraw5.png" load("images/0000000005.png")
    @test_reference "refs/partialdraw10.png" load("images/0000000010.png")
    @test_reference "refs/partialdraw15.png" load("images/0000000015.png")
    @test_reference "refs/partialdraw18.png" load("images/0000000018.png")
